...
@Service
public class PODSummaryService {

    Logger log = LogManager.getLogger(PODSummaryService.class);
    private static final String logo_path = "/jasper/images/stackextend-logo.png";
    private final String invoice_template_path = "/jasper/Pod-Summary.jrxml";

    public File generateInvoiceFor(Client client, List<AccountCopy> accountCopies, Locale locale) throws IOException {

        File pdfFile = File.createTempFile("my-pod-summary", ".pdf");
        ...
        try(FileOutputStream pos = new FileOutputStream(pdfFile))
        {
            ...
            final Map<String, Object> parameters = parameters(client, locale);
    ...
    private Map<String, Object> parameters(Client client, Locale locale) {
